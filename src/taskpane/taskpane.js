...
return model.isTemplateLoaded && (model.currentProject.id !== getSelectedProject().id || model.currentArtifact.id !== getSelectedArtifact().id);
}
/*
*
* ============
...
function createTemplateAttempt() {	 
  ...
  if (isGoogle) {
    google.script.run
      ...
      .warn('All data on the active sheet will be replaced. Continue?');
  } else {
    // MS Excel
  }
}
